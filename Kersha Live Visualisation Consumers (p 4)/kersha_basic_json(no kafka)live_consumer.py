"""
kersha_basic_json(no kafka)live_consumer.py

Read a JSON-formatted file as it is being written and visualize author message counts in real time.
...
def update_chart():
    ...
    ax.set_title("Kersha's Basic Real-Time Author Message Counts")  # Updated title
